/**
 * Logic responsible for automatic testing of the setup and doing routine maintanance (for example: open/close the valve once in a while, so it doesn't get stuck).
 *
 */
